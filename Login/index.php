...
<div id="header">
    <div>
      ...
      <span id="headerLabel">Login page</span>
      <span id="headerDescription">LEAF</span>
    </div>
...
<br />
    ...
    <div style="font-size: 150%">
        <a href="<?php echo '//' . $_SERVER['SERVER_NAME'] . '/auth_token/?r=' . $_GET['r']; ?>" style="text-decoration: none"><div class="buttonNorm" style="text-align: center">Login with <b>PIV card</b><img src="../../libs/dynicons/?img=contact-new.svg&amp;w=32" style="padding-left: 8px" alt="Icon for PIV card" title="Icon for PIV card" /></div></a><br />
    </div>
</div>
