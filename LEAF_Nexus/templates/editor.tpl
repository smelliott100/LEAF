...
$(function() {
    ...
    positions[<!--{$rootID}-->].addControl('<div class="button" onclick="addSupervisor(\'<!--{$rootID}-->\');"><img src="../libs/dynicons/?img=system-users.svg&amp;w=32" alt="Change Supervisor" title="Change Supervisor" /> Add Supervisor</div>');
