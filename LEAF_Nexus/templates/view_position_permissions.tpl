<div id="toolbar" class="toolbar_right toolbar noprint">
    <div id="tools"><h1>Options</h1>
        <div onclick="addEmployee()"><img src="../libs/dynicons/?img=list-add.svg&amp;w=32" style="vertical-align: middle" alt="Add Position" title="Add Position" /> Add Employee</div>
...
function addEmployee() {
    ...
    dialog.setSaveHandler(function() {
        ...
        $.ajax({
        	type: 'POST',
            url: './api/position/<!--{$positionID}-->/permissions/addEmployee',
...
function addPosition() {
    ...
    dialog.setSaveHandler(function() {
        ...
        $.ajax({
        	type: 'POST',
            url: './api/position/<!--{$positionID}-->/permissions/addPosition',
...
function addGroup() {
    ...
    dialog.setSaveHandler(function() {
        ...
        $.ajax({
        	type: 'POST',
            url: './api/position/<!--{$positionID}-->/permissions/addGroup',
...
function togglePermission(categoryID, UID, type)
{
    $.ajax({
    	type: 'POST',
        url: "./api/position/<!--{$positionID}-->/permission/_" + categoryID + "/" + UID + "/_" + type + "/toggle",
