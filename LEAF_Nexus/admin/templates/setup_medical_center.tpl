...
function setupLeadership() {
	...
	$('#setupContainer').html('<div id="leaderHeader"><div class="buttonNorm" onclick="createGroup();" style="float: right; width: 150px; font-size: 120%"><img src="../../libs/dynicons/?img=list-add.svg&w=32" alt="Create Group" /> Create <span id="leadershipNomenclature" style="font-size: 14px">Group</span></div><br style="clear: both" /></div>\
			<div id="leaders"></div>');
