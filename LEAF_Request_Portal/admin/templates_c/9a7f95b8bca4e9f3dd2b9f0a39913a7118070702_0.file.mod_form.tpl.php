<?php
/* Smarty version 3.1.33, created on 2018-12-19 22:28:24
  from 'C:\d0x\www\LEAF\LEAF\LEAF_Request_Portal\admin\templates\mod_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c1ac6084f2b04_86368777',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9a7f95b8bca4e9f3dd2b9f0a39913a7118070702' => 
    array (
      0 => 'C:\\d0x\\www\\LEAF\\LEAF\\LEAF_Request_Portal\\admin\\templates\\mod_form.tpl',
      1 => 1544607160,
      2 => 'file',
    ),
  ),
...
function content_5c1ac6084f2b04_86368777 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_subTemplateRender("file:site_elements/generic_simple_xhrDialog.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
echo '<script'; ?>
>
...
function unmergeForm(categoryID, stapledCategoryID) {
    $.ajax({
        type: 'DELETE',
        url: '../api/formEditor/_'+ categoryID +'/stapled/_'+ stapledCategoryID + '&CSRFToken=<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
',
        success: function() {
        	mergeFormDialog(categoryID);
        }
...
function deleteForm() {
	...
	dialog_confirm.setSaveHandler(function() {
		$.ajax({
			type: 'DELETE',
			url: '../api/?a=formStack/_' + currCategoryID + '&CSRFToken=<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
',
			success: function(res) {
			    if(res != true) {
			        alert(res);
...
function showFormBrowser() {
    ...
    $.ajax({
        type: 'GET',
        url: '<?php echo $_smarty_tpl->tpl_vars['APIroot']->value;?>
?a=formStack/categoryList/all',
        success: function(res) {
...
$(function() {
    ...
    portalAPI.setCSRFToken('<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
');

    showFormBrowser();
    <?php if ($_smarty_tpl->tpl_vars['form']->value != '') {?>
    postRenderFormBrowser = function() { selectForm('<?php echo $_smarty_tpl->tpl_vars['form']->value;?>
') };
    <?php }?>

    <?php if ($_smarty_tpl->tpl_vars['referFormLibraryID']->value != '') {?>
    postRenderFormBrowser = function() { $('.formLibraryID_<?php echo $_smarty_tpl->tpl_vars['referFormLibraryID']->value;?>
')
