...
/* Smarty version 3.1.33, created on 2018-12-19 22:28:17
  from 'C:\d0x\www\LEAF\LEAF\LEAF_Request_Portal\admin\templates\mod_groups.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c1ac6017d6a57_19185835',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9150396d48d81aabadeca8ee3f2b0bed2edef94d' => 
    array (
      0 => 'C:\\d0x\\www\\LEAF\\LEAF\\LEAF_Request_Portal\\admin\\templates\\mod_groups.tpl',
      1 => 1543348772,
      2 => 'file',
    ),
  ),
...
function content_5c1ac6017d6a57_19185835 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            for(var i in res) {
                ...
                if(res[i].groupID != 1) { // if not admin
                    function openGroup(groupID, parentGroupID) {
                        dialog_simple.setContent('<iframe src="<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/?a=view_group&groupID=' + groupID + '&iframe=1" tabindex="0" style="width: 99%; height: 99%; border: 0px; background:url(../images/largespinner.gif) center top no-repeat;"></iframe>');
...
function tagAndUpdate(groupID, callback) {
    $.when(
            $.ajax({
                type: 'POST',
                url: '<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/api/?a=group/'+ groupID + '/tag',
                data: {
                    tag: '<?php echo $_smarty_tpl->tpl_vars['orgchartImportTag']->value;?>
',
                    CSRFToken: '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'
                },
...
function importGroup() {
    ...
    groupSel.apiPath = '<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/api/?a=';
    groupSel.basePath = '../';
