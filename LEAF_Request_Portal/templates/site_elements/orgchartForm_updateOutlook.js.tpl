    orgchartForm.addUpdateEvent(5, function(response) {
        ...
        dialog.setContent('<div style="border: 1px solid black; background-color: #e0e0e0"><div style="float: left; padding: 32px"><img src="../libs/dynicons/?img=contact-new.svg&amp;w=72" alt="NT Account Password Required" /></div>\
                   <div style="padding-top: 42px">Please enter your Windows Account password to update the Outlook address book.\
                   <br /><br /><span style="font-size: 120%"><!--{$userID}--></span><br /><br /><label
                               for="NTPW"></label><input id="NTPW" type="password" />\
                   </div><br /><br /></div>');
