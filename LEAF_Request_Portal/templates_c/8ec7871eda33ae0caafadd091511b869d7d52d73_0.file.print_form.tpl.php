<?php
/* Smarty version 3.1.33, created on 2019-01-08 13:24:48
  from 'C:\d0x\www\LEAF\LEAF\LEAF_Request_Portal\templates\print_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c34eaf0ecbbd3_23234250',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8ec7871eda33ae0caafadd091511b869d7d52d73' => 
    array (
      0 => 'C:\\d0x\\www\\LEAF\\LEAF\\LEAF_Request_Portal\\templates\\print_form.tpl',
      1 => 1546549874,
      2 => 'file',
    ),
  ),
...
function content_5c34eaf0ecbbd3_23234250 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\d0x\\www\\LEAF\\LEAF\\libs\\smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),1=>array('file'=>'C:\\d0x\\www\\LEAF\\LEAF\\libs\\smarty\\plugins\\modifier.sanitize.php','function'=>'smarty_modifier_sanitize',),));
...
<div style="font-size: 36px"><img src="../libs/dynicons/?img=emblem-unreadable.svg&amp;w=96" alt="Unreadable" style="float: left" /> Notice: This request has been marked as deleted.<br />
    <span class="buttonNorm" onclick="restoreRequest(<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
)"><img src="../libs/dynicons/?img=user-trash-full.svg&amp;w=32" alt="un-delete" /> Un-delete request</span>
...
<div id="toolbar" class="toolbar_right toolbar noprint">
    <div id="tools" class="tools"><h1>Tools</h1>
        <?php if ($_smarty_tpl->tpl_vars['submitted']->value == 0) {?>
        <button class="tools"  onclick="window.location='?a=view&amp;recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
'" ><img src="../libs/dynicons/?img=edit-find-replace.svg&amp;w=32" alt="Guided editor" title="Guided editor" style="vertical-align: middle" /> Edit this form</button>
        <br />
        <br />
        <?php }?>
        ...
        <button class="tools" onclick="window.location='mailto:?subject=FW:%20Request%20%23<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
%20-%20<?php echo rawurlencode($_smarty_tpl->tpl_vars['title']->value);?>
&amp;body=Request%20URL:%20<?php if ($_SERVER['HTTPS'] == 'on') {?>https<?php } else { ?>http<?php }?>://<?php echo $_SERVER['SERVER_NAME'];
echo rawurlencode($_SERVER['REQUEST_URI']);?>
%0A%0A'" ><img src="../libs/dynicons/?img=internet-mail.svg&amp;w=32" alt="Write Email" title="Write Email" style="vertical-align: middle"/> Write Email</button>
        <?php if ($_smarty_tpl->tpl_vars['bookmarked']->value == '') {?>
...
?>
            <div><span class="comments_time"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['comments']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['time'],' %b %e'), ENT_QUOTES, 'UTF-8', true);?>
</span>
                <span class="comments_name"><?php echo smarty_modifier_sanitize($_smarty_tpl->tpl_vars['comments']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['actionTextPasttense']);?>
 by <?php echo $_smarty_tpl->tpl_vars['comments']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['name'];?>
</span>
                <div class="comments_message"><?php echo smarty_modifier_sanitize($_smarty_tpl->tpl_vars['comments']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['comment']);?>
</div>
            </div>
        <?php
}
...
?>
    ...
    <div id="category_list">
        <h1>Internal Use</h1>
        <button class="IUbutton" onclick="scrollPage('formcontent');openContent('ajaxIndex.php?a=printview&amp;recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
'); "style="vertical-align: middle; background-image: url(../libs/dynicons/?img=text-x-generic.svg&amp;w=16); background-repeat: no-repeat; background-position: left; text-align: left; text-indent: 20px;"> Main Request</button>
        <?php
$__section_i_1_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['childforms']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_i_1_total = $__section_i_1_loop;
$_smarty_tpl->tpl_vars['__smarty_section_i'] = new Smarty_Variable(array());
if ($__section_i_1_total !== 0) {
for ($__section_i_1_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] = 0; $__section_i_1_iteration <= $__section_i_1_total; $__section_i_1_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']++){
?>
            <button class="IUbutton" onclick="scrollPage('formcontent');openContent('ajaxIndex.php?a=internalonlyview&amp;recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
&amp;childCategoryID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['childforms']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['childCategoryID']);?>
');" style="vertical-align: middle; background-image: url(../libs/dynicons/?img=text-x-generic.svg&amp;w=16); background-repeat: no-repeat; background-position: left; text-align: center"> <?php echo smarty_modifier_sanitize($_smarty_tpl->tpl_vars['childforms']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['childCategoryName']);?>
</button>
        <?php
}
}
...
$_smarty_tpl->_subTemplateRender("file:site_elements/generic_dialog.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
...
function updateTags() {
	...
	$.ajax({
		type: 'GET',
		url: "./api/?a=form/<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
/tags",
...
function getIndicator(indicatorID, series) {
    $.ajax({
        type: 'GET',
        url: "ajaxIndex.php?a=getprintindicator&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
&indicatorID=" + indicatorID + "&series=" + series,
        dataType: 'text',
        success: function(response) {
...
function updateProgress() {
    $.ajax({
        type: 'GET',
        url: "./api/form/<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
/progress",
        dataType: 'json',
        success: function(response) {
            if(response < 100) {
            ...
            else if('<?php echo $_smarty_tpl->tpl_vars['submitted']->value;?>
' == '0') {
                $('#progressBar').progressbar('option', 'value', response);
                $('#progressLabel').text(response + '%');
                ...
                $.ajax({
                    type: 'GET',
                    url: "ajaxIndex.php?a=getsubmitcontrol&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
",
                    dataType: 'text',
                    success: function(response) {
...
function restoreRequest() {
	$.ajax({
		...
		data: {restore: <?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value), ENT_QUOTES, 'UTF-8', true);?>
,
            CSRFToken: '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'},
        success: function(response) {
            if(response > 0) {
                window.location.href="index.php?a=printview&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
";
            }
        }
	});
...
function addBookmark() {
    $.ajax({
        type: 'POST',
        url: "ajaxIndex.php?a=addbookmark&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
",
        data: {CSRFToken: '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'},
        success: function(response) {
...
function removeBookmark() {
    $.ajax({
        type: 'POST',
        url: "ajaxIndex.php?a=removebookmark&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
",
        data: {CSRFToken: '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'},
        success: function(response) {
...
function viewHistory() {
	...
	$.ajax({
		type: 'GET',
		url: 'ajaxIndex.php?a=getstatus&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
',
		dataType: 'text',
		success: function(res) {
			 dialog_message.setContent(res);
...
function cancelRequest() {
	...
	dialog_confirm.setSaveHandler(function() {
		$.ajax({
			type: 'POST',
			url: 'api/form/<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value), ENT_QUOTES, 'UTF-8', true);?>
/cancel',
			data: {CSRFToken: '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'},
            success: function(response) {
            	if(response == 1) {
                    window.location.href="index.php?a=cancelled_request&cancelled=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
";
                }
            	else {
            		alert(response);
...
function changeTitle() {
	dialog.setContent('Title: <input type="text" id="title" style="width: 300px" name="title" value="<?php echo preg_replace("%(?<!\\\\)'%", "\'",$_smarty_tpl->tpl_vars['title']->value);?>
...
function admin_changeStep() {
    ...
    $.ajax({
        type: 'GET',
        url: 'api/?a=formWorkflow/<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
/currentStep',
        dataType: 'json',
        success: function(res) {
        	var workflows = {};
...
";
            ...
            // find current forms
            var query = {terms: [{id: 'recordID', operator: '=', match: '<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
'}],joins: ['categoryNameUnabridged']};
            $.ajax({
                ...
                dataType: 'json',
                success: function(res) {
                	var temp = res[<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value), ENT_QUOTES, 'UTF-8', true);?>
].categoryNamesUnabridged;
...
this.portalAPI.setCSRFToken('<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
');
...
$(function() {
    ...
    form.setRecordID(<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value), ENT_QUOTES, 'UTF-8', true);?>
);

    workflow = new LeafWorkflow('workflowcontent', '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
');
    <?php if ($_smarty_tpl->tpl_vars['submitted']->value > 0) {?>
    workflow.getWorkflow(<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value), ENT_QUOTES, 'UTF-8', true);?>
);
    <?php }?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['childCategoryID']->value == '') {?>
    openContent('ajaxIndex.php?a=printview&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
');
    <?php } else { ?>
    openContent('ajaxIndex.php?a=internalonlyview&recordID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['recordID']->value);?>
&childCategoryID=<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['childCategoryID']->value);?>
');
    <?php }?>
