<?php
/* Smarty version 3.1.33, created on 2019-01-23 10:32:33
  from 'C:\d0x\www\LEAF\LEAF\LEAF_Request_Portal\templates\view_reports.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c488911ee5130_25123674',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd9518fb8f4a938bfcd36ec09713c3fbe850a10d9' => 
    array (
      0 => 'C:\\d0x\\www\\LEAF\\LEAF\\LEAF_Request_Portal\\templates\\view_reports.tpl',
      1 => 1548257516,
      2 => 'file',
    ),
  ),
...
function content_5c488911ee5130_25123674 (Smarty_Internal_Template $_smarty_tpl) {
?><style>
/* 3 column grid */
...
<div id="step_1" style="<?php if ($_smarty_tpl->tpl_vars['query']->value != '' && $_smarty_tpl->tpl_vars['indicators']->value != '') {?>display: none; <?php }?>width: 70%; background-color: white; border: 1px solid black; margin: auto; padding: 0px">
...
$_smarty_tpl->_subTemplateRender("file:site_elements/generic_xhrDialog.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
echo '<script'; ?>
>
...
');
    ...
    <?php if ($_smarty_tpl->tpl_vars['query']->value == '' || $_smarty_tpl->tpl_vars['indicators']->value == '') {?>
    loadSearchPrereqs();
    isNewQuery = true;
    <?php }?>
 ...
 >= 3) {
    ...
    function loadReport() {
        ...
        var inIndicators;
        var title = '';
        title = atob('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'UTF-8', true);?>
');
        ...
        try {
        	if(<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
 >= 2) {
        	    var query = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['query']->value, ENT_QUOTES, 'UTF-8', true);?>
';
        	    var indicators = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['indicators']->value, ENT_QUOTES, 'UTF-8', true);?>
';
                ...
                inQuery = JSON.parse(atob('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['query']->value, ENT_QUOTES, 'UTF-8', true);?>
'));
                t_inIndicators = JSON.parse(atob('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['indicators']->value, ENT_QUOTES, 'UTF-8', true);?>
'));
        	}
        	inIndicators = [];
        	for(var i in t_inIndicators) {
