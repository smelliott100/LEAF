...
<br />
    ...
    <a href="<?php echo '../auth_domain/?' . htmlentities($_SERVER['QUERY_STRING']); ?>" style="text-decoration: none"><div class="buttonNorm" style="text-align: center">Login with <b>Username and Password</b></div></a>
    </div>
